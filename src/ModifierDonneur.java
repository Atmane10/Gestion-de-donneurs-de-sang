...
public class ModifierDonneur extends JFrame {
	...
	public ModifierDonneur() { 
			...
			// Sauvegarder les modifications apporter au donneur  
			...
			btnNewButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						s.executeUpdate("update donneur set numeroDonneur='"+numeroDonneur+"',nom='"+nom+"',prenom='"+prenom+"',genre='"+genre+"',groupeSanguin='"+groupeSanguin+"',telephonePortable='"+telephonePortable+"',email='"+email+"',ville='"+ville+"',age='"+age+"'");
